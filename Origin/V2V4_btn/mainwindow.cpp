...
//        ui->label_status->setText(QString("입력: %1").arg(input));
	...
	// The code below is a protection code : wait the player to choose mal
//	case 'M':
//    	    if (malSelected == P11 || malSelected == P12 || malSelected == P21 || malSelected == P22) {
//        	if (status[malSelected] != SCORE) {
//            	    moveSelectedPiece();
//        	} else {
//            	    qDebug() << "선택된 말이 이미 도착했습니다. 이동 취소.";
//        	}
//    	    } else {
//        	qDebug() << "아직 어떤 말도 선택되지 않았습니다. 이동 무시.";
//    	    }
//    	    break;
